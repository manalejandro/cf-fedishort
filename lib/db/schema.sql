-- FediShort D1 Database Schema
-- Run with: wrangler d1 execute cf-fedishort --remote --file=lib/db/schema.sql
...
CREATE INDEX IF NOT EXISTS idx_short_links_actor ON short_links(actor_id);
CREATE UNIQUE INDEX IF NOT EXISTS idx_short_links_slug_unique ON short_links(slug);
